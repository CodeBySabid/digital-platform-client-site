        ...
        <div>
            <div>
                <div className="w-[320px] max-w-md p-8 rounded-2xl bg-white/10 backdrop-blur-md shadow-xl">
                    ...
                    {/* Register */}
                    <p className="text-center mt-4 text-sm">Already have an account?<Link to={'/login'} className="font-semibold cursor-pointer hover:underline hover:text-blue-600"> Login</Link></p>
